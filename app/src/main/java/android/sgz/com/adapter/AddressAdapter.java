...
public class AddressAdapter extends RecyclerView.Adapter<AddressAdapter.MyHolder> {
    ...
    private IRecycleViewOnItemClickListener mOnItemClickLisenter;
    ...
    public void setOnItemClickLisenter(IRecycleViewOnItemClickListener onItemClickLisenter) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (null != mOnItemClickLisenter) {
                    mOnItemClickLisenter.onItemClick(view,position);
                }
            }
        });
    }
