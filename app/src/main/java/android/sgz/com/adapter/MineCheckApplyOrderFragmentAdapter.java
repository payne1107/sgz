...
public class MineCheckApplyOrderFragmentAdapter extends BaseAdapter {
    private Context mContext;
    private List<MineApplyOrderListBean.DataBean.ListBean> mList;

    public MineCheckApplyOrderFragmentAdapter(Context context, List<MineApplyOrderListBean.DataBean.ListBean> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (bean != null) {
            ...
            if (userBean != null) {
                ...
                holder.tvApprovePerson.setText(StringUtils.isEmpty(realName) ? "" : "申请人：" + realName);
            }
            if (projectBean != null) {
